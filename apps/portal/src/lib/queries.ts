...
export const queryKeys = {
  ...
  notifications: (params?: Record<string, unknown>) => params ? ['notifications', params] as const : ['notifications'] as const,
  aiInsights: (branchId?: string | null) => branchId ? ['ai', 'insights', 'weekly', branchId] as const : ['ai', 'insights', 'weekly', 'admin'] as const,
};
